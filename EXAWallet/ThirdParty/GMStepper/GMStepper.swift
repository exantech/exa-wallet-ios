...
@IBDesignable public class GMStepper: UIControl {
    ...
    @objc @IBInspectable public var buttonsInactiveTextColor: UIColor = UIColor.gray {
        didSet {
            for button in [leftButton, rightButton] {
                button.setTitleColor(buttonsInactiveTextColor, for: .highlighted)
            }
        }
    }
    ...
    */
    ...
    func updateVisibility() {
        leftButton.isHidden = (Int(value) == Int(minimumValue))
        rightButton.isHidden = (Int(value) == Int(maximumValue))
    }
